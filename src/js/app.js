...
////////////////////////////////////////////////////////////////// smj agya hai
  render: function() {
    ...
    // Load account data
    web3.eth.getCoinbase(function(err, account) {   // it shows that miners are getting reward for for generating ou new block
      if (err === null) {
        App.account = account;
      ...
      for (var i = 1; i <= candidatesCount; i++) {
        electionInstance.candidates(i).then(function(candidate) {
          ...
          // Render candidate Result
            var candidateTemplate = "<tr><th>" + id + "</th><td>" + name + "</td><td>" + partyname + "</th><td>" + voteCount + "</td></tr>"
...
{
App.contracts.Election.deployed().then(function(instance) {
      return instance.addCandidate(candidateadd, candidatepartyadd, { from: App.account });
